...
![[_assets/installing_on_windows.png]]

If you are a macOS user, click the button encircled in red.

![[_assets/installing_on_macOS.png]]
...
![[_assets/opening_python_shell.png]]
...
![[_assets/adding_on_python_shell.png]]

Well done, you wrote your first Python script on Python interactive shell. How do we close the Python interactive shell ?
To close the shell, next to this symbol >>> write **exit()** command and press Enter.

![[_assets/exit_from_shell.png]]

Now, you know how to open the Python interactive shell and how to exit from it.

Python will give you results if you write scripts that Python understands, if not it returns errors. Let's make a deliberate mistake and see what Python will return.

![[_assets/invalid_syntax_error.png]]
...
![[_assets/fixing_syntax_error.png]]
...
![[_assets/maths_on_python_shell.png]]
...
![[_assets/writing_string_on_shell.png]]
...
![[_assets/helloworld.png]]

After a long day of coding, you want to close your code editor, right? This is how you will close the opened project.

![[_assets/closing_opened_project.png]]
...
![[_assets/checking_data_types.png]]
...
![[_assets/running_python_script.png]]
...
本日配套的 Python 源码（原始路径：`readme.md` 目录）：
