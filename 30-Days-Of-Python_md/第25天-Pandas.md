---
tags: [python, "30天python", "day25"]
天数: 25
标题: "Pandas"
source: "Chinese/25_pandas_cn.md"
---
...
![[_assets/pandas-series-1.png]] 

国家系列

![[_assets/pandas-series-2.png]] 

城市系列

![[_assets/pandas-series-3.png]]

如你所见，pandas系列只是一列数据。如果我们想要有多列，我们使用数据框。下面的例子显示了pandas数据框。

让我们看一个pandas数据框的例子：

![[_assets/pandas-dataframe-1.png]]

数据框是行和列的集合。看看下面的表格；它比上面的例子有更多的列：

![[_assets/pandas-dataframe-2.png]]
