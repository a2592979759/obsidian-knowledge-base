...
![[QWidgetDemo_assert/gifwidget.jpg]]

## 分类

- 类型: 窗体相关 `widget`
- 源码目录: `widget/gifwidget`

## 技术要点

**用到的 Qt 类**: QWidget QTextCodec QLabel QSizePolicy QSize QPushButton QEvent QColor QLineEdit QString QDialog QTimer QHBoxLayout QApplication QImage QPainter QPixmap QScopedPointer QObject QMouseEvent
