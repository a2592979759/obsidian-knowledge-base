...
![[QWidgetDemo_assert/playffmpeg.jpg]]

## 分类

- 类型: 视频播放 `video`
- 源码目录: `video/playffmpeg`

## 技术要点

**用到的 Qt 类**: QTextCodec QWidget QApplication QString QPushButton QCoreApplication QFont QStringList QFileDialog QVBoxLayout QHBoxLayout QComboBox
