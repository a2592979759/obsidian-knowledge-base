...
![[QWidgetDemo_assert/videobox.jpg]]
...
**用到的 Qt 类**: QString QStringList QWidget QMenu QTextCodec QWidgetList QObject QEvent QList QChar QAction QGridLayout QLabel QDateTime QMap QSizePolicy QFrame QApplication QCursor QVBoxLayout
