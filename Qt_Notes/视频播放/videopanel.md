...
![[QWidgetDemo_assert/videopanel.jpg]]

## 分类

- 类型: 视频播放 `video`
- 源码目录: `video/videopanel`
- 标注: **高质量**

## 技术要点

**用到的 Qt 类**: QString QWidget QStringList QTextCodec QMenu QWidgetList QObject QEvent QList QAction QGridLayout QSize QLabel QDateTime QChar QMap QApplication QCursor QTimer QSizePolicy
...
int main(int argc, char *argv[])
{
    ...
    frmVideoPanel w;
    w.setWindowTitle("视频监控画面 (QQ: 517216493 WX: feiyangqingyun)");
    w.resize(800, 600);
    w.show();
